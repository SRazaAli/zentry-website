...
const BentoTilt = ({ children, className = '' }) => {
    ...
    const tiltX = (relativeY - 0.5) * 5; // Controls X rotation
    const tiltY = (relativeX - 0.5) * 5; // Controls Y rotation
        ...
        <section className="bg-black pb-52">
            <div className="container mx-auto px-3 md:px-12">
                ...
                <div className="px-5 py-32">
                    ...
                    <p className="max-w-md font-circular-web text-blue-50 opacity-50">Immerse yourself in a rich and ever-expanding universe where a vibrant array of products converge into an interconnected overlay experience on your world.</p>
                </div>
                ...
                <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    ...
                    <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2 ">
                        <BentoCard
                            ...
                            title={<>zig<b>m</b>a</>}
                            description="An experimental blend of NFT, agentic AI and community IP, redefining entertainment primitives"
                        />
                    </BentoTilt>
